...
export const generatePaginationNumbers = ( currentPage: number, totalPages: number) => {
    ...
    // Si el número total de páginas es de 7 o menos se mostrarán todas las páginas sin puntos suspensivos
    if( totalPages <= 7 ) {
    ...
    // Si la página actual está entre las últimas 3 páginas, mostrar las primeras 2, puntos suspensivos y las últimas 3 
